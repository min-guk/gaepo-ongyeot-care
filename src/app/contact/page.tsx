...
export default function ContactPage() {
  return (
    <main id="main-content">
      ...
      <section className="section sage-section" aria-labelledby="visit-title"><div className="shell narrow"><p className="eyebrow">방문 전 확인</p><h2 id="visit-title">주소와 운영 시간</h2><ClaimStatus keys={["address", "hours"]} /></div></section>
