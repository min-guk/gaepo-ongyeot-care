...
export default function ContactPage() {
  return (
    <main id="main-content">
      <PageIntro eyebrow="말이 정리되지 않아도 괜찮습니다" title="지금 가장 어려운 한 가지부터 준비해 주세요" description="전화·카카오톡·온라인 문의는 실제 연결 및 개인정보 검토가 끝난 뒤 활성화합니다. 현재는 민감한 개인정보를 입력하거나 보내지 마세요." compactMascot mascotScene="contact" mascotCaption="세 가지만 천천히 메모해요." />
      <section className="section paper-section" aria-labelledby="contact-director-title"><div className="shell director-contact"><div><p className="eyebrow">상담을 준비하는 사람</p><h2 id="contact-director-title">유창순 원장이 차분히 듣겠습니다</h2><p className="lede">말을 완벽하게 정리할 필요는 없습니다. 누구의 돌봄을 알아보는지, 최근 가장 어려워진 일은 무엇인지부터 준비해 주세요.</p></div><DirectorPhoto variant="welcome" /></div></section>
