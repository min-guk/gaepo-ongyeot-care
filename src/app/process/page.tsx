...
export default function ProcessPage() {
  return (
    <main id="main-content">
      <PageIntro eyebrow="처음 알아보는 가족을 위한 순서" title="한 번에 결정하지 않고, 다섯 걸음으로 확인합니다" description="아래는 일반적인 준비 흐름입니다. 실제 이용 절차, 소요 기간, 등급과 비용은 최신 공공 기준과 센터의 검증된 안내를 함께 확인해야 합니다." mascotScene="process" mascotCaption="한 걸음씩 순서대로 확인해요." />
