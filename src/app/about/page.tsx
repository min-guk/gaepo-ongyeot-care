...
export default function AboutPage() {
  return (
    <main id="main-content">
      <PageIntro eyebrow="가까운 동네에서 시작하는 돌봄 언어" title="잘 보이기보다, 사실대로 말하는 곁이 되겠습니다" description="개포 온곁 재가복지센터는 현재 가칭입니다. 이름과 상표, 법정 기관 정보, 운영 사실은 각각의 검증을 마친 뒤 확정합니다." mascotScene="story" mascotCaption="작은 마음부터 오래 돌볼게요." />
      <section className="section director-profile-section" aria-labelledby="director-profile-title"><div className="shell director-profile"><DirectorPhoto variant="portrait" /><div><p className="eyebrow">원장 소개</p><h2 id="director-profile-title">유창순 원장입니다</h2><p className="lede">가족이 돌봄을 처음 알아볼 때 가장 힘든 것은, 무엇부터 묻고 확인해야 하는지 알기 어렵다는 점입니다.</p><p>서두르지 않아도 이해할 수 있는 말로 설명하고, 확인되지 않은 내용은 분명히 구분하는 센터를 준비하겠습니다.</p></div></div></section>
