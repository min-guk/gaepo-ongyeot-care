...
export default function RecruitmentPage() {
  return (
    <main id="main-content">
      <PageIntro eyebrow="돌봄의 태도를 함께 만드는 일" title="채용 여부와 조건은 확인된 공고만 게시합니다" description="현재 공개된 채용 공고는 없습니다. 근무 지역, 역할, 일정, 보수, 자격 조건을 운영자가 확인한 뒤에만 모집 중이라고 안내합니다." mascotScene="recruitment" mascotCaption="공고와 조건을 먼저 확인해요." />
