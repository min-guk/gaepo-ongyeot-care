    ...
    <footer className="site-footer focus-surface-dark" id="privacy">
      <div className="shell footer-grid">
        <div>
          ...
          <p className="footer-tagline">돌봄의 무게, 가까운 곁에서 나눕니다.</p>
        ...
        <div aria-labelledby="privacy-title">
          ...
          <p className="footer-links"><Link href="/privacy">개인정보 안내</Link><Link href="/contact">문의 준비</Link><Link href="/recruitment">채용 안내</Link></p>
        </div>
      </div>
    </footer>
  );
